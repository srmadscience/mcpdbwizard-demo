...
CREATE TABLE "HOTEL_ROOMS"
   (   "HOTEL_NAME"            VARCHAR2(20 BYTE)  NOT NULL ENABLE,
       ...
       USING INDEX ENABLE,
       CONSTRAINT "HOTEL_ROOMS_FK1" FOREIGN KEY ("HOTEL_NAME")
          REFERENCES "HOTELS" ("HOTEL_NAME") ON DELETE CASCADE ENABLE);
...
CREATE TABLE "COMPLAINTS"
   (   "COMPLAINT_ID"    NUMBER             DEFAULT complaint_id_seq.NEXTVAL NOT NULL ENABLE,
       "CUSTOMER_NAME"   VARCHAR2(20 BYTE)  NOT NULL ENABLE,
       "COMPLAINT_DATE"  DATE               DEFAULT SYSDATE NOT NULL ENABLE,
       "COMPLAINT_TEXT"  VARCHAR2(400 BYTE) NOT NULL ENABLE,
       "RESOLVED_Y_OR_N" VARCHAR2(1 BYTE)   DEFAULT 'N' NOT NULL ENABLE,
       CONSTRAINT "COMPLAINTS_PK" PRIMARY KEY ("COMPLAINT_ID") USING INDEX ENABLE,
       CONSTRAINT "COMPLAINTS_CHK1" CHECK (RESOLVED_Y_OR_N IN ('Y','N')) ENABLE,
       CONSTRAINT "COMPLAINTS_FK1" FOREIGN KEY ("CUSTOMER_NAME")
          REFERENCES "CUSTOMERS" ("CUSTOMER_NAME") ENABLE
   );

CREATE INDEX "COMPLAINTS_CUSTOMER_NAME" ON "COMPLAINTS" ("CUSTOMER_NAME");
